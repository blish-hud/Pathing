...
namespace BhModule.Community.Pathing.Entity {
    public partial class StandardTrail {
        ...
        private void Populate_MapVisibility(AttributeCollection collection, IPackResourceManager resourceManager) {
            this.MiniMapVisibility = _packState.UserResourceStates.Population.TrailPopulationDefaults.MiniMapVisibility;
            this.MapVisibility     = _packState.UserResourceStates.Population.TrailPopulationDefaults.MapVisibility;
            this.InGameVisibility  = _packState.UserResourceStates.Population.TrailPopulationDefaults.InGameVisibility;
