...
namespace BhModule.Community.Pathing {
    ...
    public class ModuleSettings {
        ...
        private void InitPackSettings(SettingCollection settings) {
            ...
            this.PackAllowInfoText                        = this.PackSettings.DefineSetting(nameof(this.PackAllowInfoText),                        true, () => "Allow Markers to Show Info On-Screen", () => "If enabled, certain markers will be able to show information when your character is close to the marker.");
