        ...
        protected override void Paint(SpriteBatch spriteBatch, Rectangle bounds) {
            ...
            if (_enabled) {
                spriteBatch.DrawOnCtrl(this,
                                       ...
                                       Color.FromNonPremultiplied(73 + 50, 88 + 69, 111 + 81, 255));
            } else {
                // TODO: Use the actual button texture instead
                spriteBatch.DrawOnCtrl(this,
                                       ContentService.Textures.Pixel,
                                       new Rectangle(3, 3, _size.X - 6, _size.Y - 5),
                                       Color.FromNonPremultiplied(73, 88, 111, 255));
            }
            ...
            _textColor = _enabled ? StandardColors.Default : Color.FromNonPremultiplied(51, 51, 51, 255);
            // Button Text
